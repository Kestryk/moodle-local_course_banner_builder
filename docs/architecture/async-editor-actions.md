...
present, and that the official AMD/CSS outputs contain their canonical module
and shared busy-state selectors. It does not replace a Moodle 5.1 interaction
