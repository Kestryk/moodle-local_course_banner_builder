...
the Moodle 5.1 CCB preview. Its product prerequisite is commit `3b37a67`.
Platform must register the scenario in the CCB allowlist before running it
under the shared runtime lease.
...
publish `3b37a67` together with the commit containing this specification, and
acquire the CCB runtime lease.
