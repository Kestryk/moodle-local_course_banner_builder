...
the Moodle 5.1 CCB preview. The containing integration commit ports only the
Settings and Transfer hunks from `3b37a67` and this scenario from `7d9b50d`
onto the cumulative preview base `53e5676`.
