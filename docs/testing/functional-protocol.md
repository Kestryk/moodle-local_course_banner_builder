...
| NAV-01 | Open every CCB administration destination | Rail exposes Course, Site, Slideshow and Transfer with the active view identified | Playwright/manual | Candidate |
| NAV-02 | Open and close the compact rail | Trigger, backdrop, Escape and focus return work without a horizontal overflow | Playwright/manual | Candidate |
...
| GUIDE-04 | Open Guide from the compact CCB rail | Launcher closes the panel; Guide opens above it and returns focus after close | Playwright/manual | Candidate |
