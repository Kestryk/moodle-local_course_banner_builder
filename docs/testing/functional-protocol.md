...
| NAV-01 | Open every CCB administration destination | Rail exposes Course, Site, Slideshow, Transfer, Course format and Site format; desktop is a flat EasyStud rail without resting item cards, while compact icons use the EasyStud neutral tile and primary active state | Playwright/manual | Candidate |
