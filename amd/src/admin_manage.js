...
function localCourseBannerBuilderDeleteSelectedPreviewLayer(button) {
    ...
    localCourseBannerBuilderConfirmAction(message).then(function (confirmed) {
        ...
        fetch(window.location.href, {
            ...
            if (!response.ok) {
                throw new Error(localCourseBannerBuilderGetJsString(
                    'unabletodeleteselectedlayer', 'Unable to delete selected layer'
                ));
            }
            ...
            localCourseBannerBuilderNotifyAsyncAction(
                data.message || localCourseBannerBuilderGetJsString('bannerdeleted', 'Layer deleted.'), 'success'
            );
            localCourseBannerBuilderFocusAfterAsyncDelete(
                host, '[data-action="local-course-banner-builder-delete-selected-preview-layer"]'
            );
        }).catch(function (error) {
            window.console.error(error);
            localCourseBannerBuilderNotifyAsyncAction(error.message || localCourseBannerBuilderGetJsString(
                'unabletodeleteselectedlayer', 'Unable to delete selected layer'
            ), 'error');
...
function localCourseBannerBuilderNotifyAsyncAction(message, type) {
    ...
    Notification.addNotification({message: message, type: type, closebutton: true, announce: true});
}
...
function localCourseBannerBuilderDeleteAllLayers(button) {
    ...
    localCourseBannerBuilderConfirmAction(message).then(function (confirmed) {
        ...
        fetch(window.location.href, {
            ...
            window.console.error(error);
            localCourseBannerBuilderNotifyAsyncAction(error.message || localCourseBannerBuilderGetJsString(
                'unabletodeletealllayers', 'Unable to delete all layers'
            ), 'error');
            if (button.isConnected) {
                button.focus({preventScroll: true});
            }
...
function localCourseBannerBuilderDeleteSelectedLayers(button) {
    ...
    localCourseBannerBuilderConfirmAction(message).then(function (confirmed) {
        ...
        fetch(window.location.href, {
            ...
            localCourseBannerBuilderFocusAfterAsyncDelete(
                host, '[data-action="local-course-banner-builder-delete-selected-layers"]'
            );
        }).catch(function (error) {
            window.console.error(error);
            localCourseBannerBuilderNotifyAsyncAction(error.message || localCourseBannerBuilderGetJsString(
