...
$string['dynamicimagesizeenabled'] = 'Image à taille dynamique';
$string['dynamicimagesizeenabled_help'] = 'Si cette option est activée, l’image n’est plus rendue dans la bannière générée. Elle est ajoutée comme un calque HTML/CSS au-dessus de la bannière et conserve un redimensionnement responsive avec les réglages de taille, placement et espacement.';
